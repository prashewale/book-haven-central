...
import { Heart, Share2, ShieldCheck, Truck, Star, ArrowLeft } from 'lucide-react';
    ...
    return (
      <div className="container mx-auto px-4 py-20 text-center space-y-4">
        ...
        <Button variant="outline" asChild>
          <Link to="/books"><ArrowLeft className="h-4 w-4 mr-2" /> Back to Books</Link>
        </Button>
      </div>
    );
  }
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        >
          <div className="space-y-3">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold leading-tight">{book.title}</h1>
            <p className="text-lg text-muted-foreground">
              by <span className="text-foreground font-medium underline underline-offset-4 decoration-primary/30">{book.author}</span>
            </p>
          ...
          <FormatSelector formats={book.formats} selected={selectedFormat} onSelect={setSelectedFormat} />

          <div className="flex gap-3 pt-2">
            <Button size="lg" className="flex-1 h-14 rounded-full text-base shadow-warm" onClick={handleAddToCart}>
              Add to Cart
            </Button>
          ...
          <div className="grid grid-cols-2 gap-6 pt-6 border-t">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">100% SSL encrypted</p>
              </div>
            </div>
          </div>
